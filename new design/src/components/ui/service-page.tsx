...
const SERVICE_DETAILS: Record<string, Record<'uz' | 'ru', ServiceData>> = {
  "Branding": {
    uz: {
      title: "Branding",
    ...
    ru: {
      title: "Брендинг",
      description: "Запоминающийся бренд\n\nЛоготип, цвета и стиль — все это создает единый образ, отличающий вас от конкурентов. Сильный бренд — это когда клиент узнает вас с первого взгляда: «Ага, это же они!».",
      whyNeed: [
        "Ваш бренд выглядит профессионально",
        "Вы выделяетесь на фоне конкурентов",
        "У клиентов появляется доверие",
        "Повышается узнаваемость бренда (Brand recognition)",
        "Вы конкурируете ценностью, а не ценой",
        "Строится долгосрочный и стабильный бизнес"
      ],
      whatWeDo: [
        { title: "Разрабатываем бренд-стратегию", desc: "Определяем позиционирование бренда на основе вашего рынка, аудитории и целей." },
        { title: "Создаем логотип и визуальный стиль", desc: "Разрабатываем логотип, цветовую палитру, шрифты и общий стиль дизайна." },
        { title: "Готовим брендбук", desc: "Создаем полное руководство по правильному использованию элементов бренда." },
        { title: "Разрабатываем нейминг и слоган", desc: "Подбираем подходящее, запоминающееся название и слоган для вашего бренда." },
        { title: "Брендирование профилей и страниц", desc: "Приводим Instagram, Telegram, сайт и другие платформы к единому стилю." },
        { title: "Создаем визуальный контент", desc: "Готовим посты, баннеры, рекламные макеты и презентации." }
      ],
      platforms: ["Instagram", "Facebook", "Telegram", "Website", "YouTube", "LinkedIn"],
      whyUs: [
        "Превращает ваш бизнес из обычного в сильный бренд",
        "Клиенты быстро запомнят и узнают вас",
        "Идеально формирует доверие и авторитет",
        "Облегчает процесс продаж и обслуживания",
        "Ваш бренд будет работать на вас долгие годы"
      ],
      note: "Если вы незаметны на рынке, брендинг — это именно то, что вам нужно."
    }
  },
  "Video Production": {
    uz: {
    ...
    ru: {
      ...
      description: "Удерживаем зрителя за 3 секунды.\n\nЕсть всего три секунды, чтобы человек перестал скроллить ленту. Мы создаем видео, которые привлекают внимание именно в эти три секунды, а затем удерживают зрителя до самого конца.",
      whyNeed: [
        "Быстро привлекает внимание аудитории",
        "Контент чаще просматривается и делится в социальных сетях",
        "Резко возрастает доверие со стороны клиентов",
        "Оказывает сильное влияние на продажи и количество заявок",
        "Укрепляется имидж бренда (Brand image)",
        "Обеспечивает более быстрый рост в алгоритмах Reels и TikTok"
      ],
      whatWeDo: [
        { title: "Разрабатываем видео-стратегию", desc: "Определяем, какой тип видео принесет вам наибольший результат." },
        { title: "Пишем сценарий", desc: "Для каждого видео готовим увлекательный сценарий, ориентированный на продажи." },
        { title: "Проводим профессиональную съемку", desc: "Снимаем на высококлассные профессиональные камеры с использованием качественного освещения." },
        { title: "Монтаж и пост-продакшн", desc: "Нарезка видео, цветокоррекция (color grading), наложение субтитров, эффектов и музыки." },
        { title: "Видео Reels / Shorts / TikTok", desc: "Готовим трендовые, короткие и потенциально вирусные креативные ролики." },
        { title: "Создаем рекламные ролики", desc: "Создаем специальные продающие видеоролики для таргет- и промо-кампаний." }
      ],
      platforms: ["Instagram", "TikTok", "YouTube", "Facebook", "Telegram", "LinkedIn"],
      whyUs: [
        "С помощью видеоконтента вы быстрее убеждаете клиентов и совершаете продажи",
        "Ваш бренд выглядит профессионально и конкурентоспособно на рынке",
        "Аудитория начинает больше доверять вашей личности или продукту",
        "Качество вашего видеоконтента будет в несколько раз выше, чем у конкурентов",
        "В таргетированной рекламе снижается стоимость получаемых заявок"
      ],
      note: "Если ваш контент не просматривают — проблема в видео. Мы решим её идеально."
    }
  },
  "Social Media Marketing": {
    ...
    ru: {
      title: "SMM (Маркетинг в соцсетях)",
      description: "С SMM вы заметны онлайн, продаете оффлайн\n\nКрасивого поста в соцсетях недостаточно — он должен зацепить человека, заинтересовать его и побудить к действию. Мы объединяем контент, дизайн и стратегию, превращая вашу страницу в эффективный инструмент привлечения реальных клиентов.",
      whyNeed: [
        "Ваш бренд выглядит активным и профессиональным в соцсетях",
        "Устанавливается прямое и доверительное общение с аудиторией",
        "Создается сообщество (community) лояльных клиентов",
        "Растет общее доверие и репутация вашего бренда",
        "Обеспечивается постоянный поток лояльных клиентов"
      ],
      whatWeDo: [
        { title: "SMM-стратегия и анализ", desc: "Анализируем конкурентов и аудиторию, составляем контент-стратегию под ваш бренд." },
        { title: "Визуальный дизайн (Grid layout)", desc: "На высшем уровне готовим общее оформление страницы, шаблоны постов и stories." },
        { title: "Планирование контента", desc: "Составляем ежемесячный план полезных, развлекательных и продающих постов и stories." },
        { title: "Профессиональный копирайтинг", desc: "Пишем вовлекающие, убедительные и грамотные тексты для публикаций." },
        { title: "Модерация (Community)", desc: "Налаживаем оперативные ответы на вопросы клиентов в Direct и комментариях." }
      ],
      platforms: ["Instagram", "Telegram", "Facebook", "TikTok", "LinkedIn"],
      whyUs: [
        "Мы не просто публикуем посты, мы повышаем имидж и вовлеченность бренда",
        "Ваша страница будет выгодно отличаться от конкурентов эстетически и содержательно",
        "Социальные сети станут самым активным каналом продаж вашего бренда"
      ],
      note: "Чем аккуратнее оформлен ваш бренд в социальных сетях, тем выше уровень доверия клиентов к вам."
    }
  },
  "Content Marketing": {
    uz: {
    ...
    ru: {
      ...
      description: "Завоевываем доверие через полезный и креативный контент\n\nМы не просто говорим «купите» — мы даем клиенту полезную и интересную информацию. Благодаря этому люди начинают доверять вам и сами принимают решение о покупке. Продвигаем бренд не рекламой, а пользой.",
      whyNeed: [
        "У клиентов формируется отношение к вам как к главному эксперту в отрасли",
        "Упрощается процесс продаж (клиенты покупают осознанно)",
        "Формируется база долгосрочных и очень лояльных клиентов",
        "Ваш бренд выходит на первые позиции в тематических поисках"
      ],
      whatWeDo: [
        { title: "Создание экспертного контента", desc: "Готовим полезные посты и статьи, наглядно демонстрирующие пользу вашего продукта." },
        { title: "Сторителлинг", desc: "Продаем через увлекательные истории о кейсах проектов, успехах клиентов и истории бренда." },
        { title: "Инфографика и гайды", desc: "Просто и визуально объясняем читателю даже самую сложную информацию." },
        { title: "Еженедельные рассылки (Newsletters)", desc: "Регулярно отправляем клиентам полезные экспертные материалы через Telegram или Email." }
      ],
      platforms: ["Telegram", "Instagram", "Website Blog", "LinkedIn", "X (Twitter)"],
      whyUs: [
        "Мы продаем не через пустую похвалу, а решая реальные проблемы клиентов",
        "Ваш бренд станет самым авторитетным экспертом в своей нише на рынке",
        "Ценность вашего контента поможет существенно снизить расходы на рекламу"
      ],
      note: "Дайте клиенту ценность первыми, и он обязательно купит именно у вас."
    }
  },
  "Performance marketing": {
    uz: {
      title: "Performance marketing",
      description: "Reklama emas — natija sotamiz\n\nBiz reklamaga pul sarflav, \"umid qilib\" kutmaymiz. Har bir mijoz qayerdan kelganini, nima uchun xarid qilganini yoki qilmaganini tahlil qilamiz. Natijada — kam xarajat bilan ko'proq mijoz, va siz aniq bilasiz: bu reklama sizga daromad olib keladi.",
      whyNeed: [
    ...
    ru: {
      ...
      description: "Не реклама — продаем результат\n\nМы не тратим деньги на рекламу в надежде на чудо. Мы анализируем, откуда пришел каждый клиент, почему он совершил покупку или отказался. Как итог — больше клиентов при меньших затратах, и вы точно знаете: эта реклама приносит вам прибыль.",
      whyNeed: [
        "Рекламный бюджет не сливается впустую, каждая копейка дает результат",
        "Отдел продаж ежедневно обеспечивается горячими заявками (лидами)",
        "Реклама показывается только той аудитории, которая вероятнее всего купит",
        "Возможность легко масштабировать продажи и количество заявок"
      ],
      whatWeDo: [
        { title: "Настройка таргетированной рекламы", desc: "Настраиваем таргет на платформах Meta Ads (Instagram, Facebook) и Telegram Ads." },
        { title: "Контекстная реклама (Google Ads)", desc: "Показываем рекламу тем клиентам, которые прямо сейчас ищут вашу услугу в поиске." },
        { title: "Ретаргетинг (Повторное привлечение)", desc: "Возвращаем тех, кто ранее интересовался или заходил на сайт, но ничего не купил." },
        { title: "Интеграция CRM и аналитики", desc: "Ведем учет заявок и реальных продаж с помощью Google Analytics и CRM-систем." }
      ],
      platforms: ["Meta Ads (Instagram / Facebook)", "Google Ads", "Telegram Ads"],
      whyUs: [
        "Мы работаем не ради красивых отчетов или лайков, а ради реальных заявок и продаж",
        "Вы будете четко понимать, сколько прибыли приносит вашему бизнесу каждый вложенный доллар",
        "За счет регулярных тестов и A/B тестирования мы максимально снижаем стоимость заявки"
      ],
      note: "Если вашему бизнесу нужны не лайки, а реальные заявки и продажи, эта услуга идеально вам подходит."
    }
  }
};
...
export const ServicePage = ({
  ...
  const details = SERVICE_DETAILS[serviceName]?.[lang] || SERVICE_DETAILS[serviceName]?.['uz'];
  ...
  return (
    <div className="min-h-screen bg-[#05020a] text-[#f3f4f6] relative overflow-hidden selection:bg-orange-500 selection:text-white">
      ...
      {/* Navigation Header */}
      <header className="fixed top-5 left-0 right-0 z-50 px-2 sm:px-4">
      ...
      <main className="max-w-4xl mx-auto px-6 pt-32 pb-24 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12 border-t border-white/5 pt-10">
          ...
          <div className="space-y-5">
            <h3 className="font-display font-bold text-xl text-white">
              {lang === 'uz' ? `Nima uchun ${details.title} kerak?` : `Зачем нужен ${details.title}?`}
            </h3>
          ...
          <div className="space-y-5">
            <h3 className="font-display font-bold text-xl text-white">
              {lang === 'uz' ? 'Quyidagi platformalarda ishlaymiz:' : 'Работаем на следующих платформах:'}
            </h3>
        ...
        <div className="space-y-5 border-t border-white/5 pt-10 mb-12">
          <h3 className="font-display font-bold text-xl text-white">
            {lang === 'uz' 
              ? `Nima uchun ${details.title} xizmatini tanlashingiz kerak:` 
              : `Почему вам стоит выбрать услугу ${details.title}:`}
          </h3>
          <ul className="space-y-3.5">
